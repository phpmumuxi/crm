...
<div class="container">
	<div class="page-header" style="border:none; font-size:14px;margin-left:-10px; ">
        <ul class="nav nav-tabs" style="margin-top:-1px;">
            ...
            <li><a href="<?php echo U('Index/index');?>">仪表盘</a></li>
        </ul>
    </div>
	...
	<div class="row" style="margin-top:10px;">
		<div class="span3 knowledgecate" >
			<div style="border-right:1px solid #d7d7d7;padding:15px;">
				<div class="personal-panel" style="position:relative; top:0;left:0;">
					<div class="avatar01" >
						<?php if(empty($userInfo['img'])): ?><a href="<?php echo U('user/edit');?>">
							<img  style="margin:0px auto;" src="__PUBLIC__/img/avatar_default.png" class="thumbnail avatar-img"/>
							<?php if($managerLog): ?><img src="__PUBLIC__/img/gj2x.png" style="height:35px;width:35px;position:absolute;top:0;right:50px;" alt="管家图标" /><?php endif; ?>
							</a>
						<?php else: ?>
							<a href="<?php echo U('user/edit');?>">
							<img style="margin:0px auto;" src="<?php echo ($userInfo["img"]); ?>" class="thumbnail avatar-img"/>
							<?php if($managerLog): ?><img src="__PUBLIC__/img/gj2x.png" style="height:35px;width:35px;position:absolute;top:0;right:50px;" alt="管家图标" /><?php endif; ?>
							</a><?php endif; ?>
					</div>
					<div class="avatar01">
						...
						<?php if($_SESSION['position_id']== '14' OR $_SESSION['position_id']== '15' OR $_SESSION['position_id']== '16'): else: ?>
							<p class="p-size">
				...
				<div class="dynamiccate">
					<ul class="nav nav-list">
						...
						<?php if(session('?admin')): if(is_array($department)): $i = 0; $__LIST__ = $department;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
...
<script type="text/javascript" src="__PUBLIC__/js/mapv2.js"></script>
