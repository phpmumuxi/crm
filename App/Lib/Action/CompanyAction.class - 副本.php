...
class CompanyAction extends Action{
	public function _initialize(){
		...
		$action = array(
			'permission'=>array(),
			'allow'=>array('index','permit','crmloginssl','delbank','validatepassword','transferbalance','addbankcard','recordlist','staff','banklist','passwordreset','cash','impUser','phone','updatastatus','addbusiness','seeevidence','cashinfo')
		);
