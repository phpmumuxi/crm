...
function list(user, start, size, keyword, type) {
	$.ajax({
		type: "post",
		url: url+'/manager/community/queryCommunityList',
		async: true,
		data: {
			userIds: user,
			start: start,
					...
					for(i = 0; i < obj.goodsList.length; i++) {
						...
						if(obj.goodsList[i].serviceGoodsBase.checkStatus == 0) {
							if(position == 14 || position == 15 ){
								...
								'<td><a href="'+view+ obj.goodsList[i].serviceGoodsBase.sid + '"><span>' + obj.goodsList[i].serviceGoodsBase.serviceName + '</span></a></td>' +
								...
								'<td><a href="' +view+ obj.goodsList[i].serviceGoodsBase.sid + '">查看</a>&nbsp;' +
									'<a href="'+testurl+'?sid=' + obj.goodsList[i].serviceGoodsBase.sid + '&goodsUserId='+obj.goodsList[i].serviceGoodsBase.userId+'">预览</a>&nbsp;</td></tr>';
							}else{
								...
								'<td>' + obj.goodsList[i].serviceGoodsBase.userNickName + '</td>' +
								'<td><a href="' +view+ obj.goodsList[i].serviceGoodsBase.sid + '">查看</a>&nbsp;' +
									'<a href="'+testurl+'?sid=' + obj.goodsList[i].serviceGoodsBase.sid + '&goodsUserId='+obj.goodsList[i].serviceGoodsBase.userId+'">预览</a>&nbsp;<a href="'+edit + obj.goodsList[i].serviceGoodsBase.sid +'&company='+obj.goodsList[i].serviceGoodsBase.userId+ '">编辑</a></td></tr>';
							}
							$("#form_container").append(liststr);
							...
							if(position == 14 || position == 15 ){
								...
								'<td>' + obj.goodsList[i].serviceGoodsBase.userNickName + '</td>' +
								'<td><a href="' +view+ obj.goodsList[i].serviceGoodsBase.sid + '">查看</a>&nbsp;' +
									'<a href="'+testurl+'?sid=' + obj.list[i].serviceGoodsBase.sid + '&goodsUserId='+obj.goodsList[i].serviceGoodsBase.userId+'">预览</a>&nbsp;<a href="'+edit + obj.goodsList[i].serviceGoodsBase.sid + '&company='+obj.goodsList[i].serviceGoodsBase.userId+ '">编辑</a></td></tr>';
								// console.log(liststr);
							}
		...
		success: function(data) {
			if(data.code == 2000) {
				...
				for(i = 0; i < obj.length; i++) {
					var listli = '<li><a href="javascript:void(0);" onclick="list(\'' + userid + '\', 0, 10,\'\', \'' + obj[i].value + '\')">' +
