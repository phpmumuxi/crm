						...
						if(obj.goodsList[i].serviceGoodsBase.checkStatus == 0) {
							if(position == 14 || position == 15 ){
								...
								'<td><a href="' +view+ obj.goodsList[i].serviceGoodsBase.sid + '">查看</a>&nbsp;' +
									'<a href="'+testurl+'?sid=' + obj.list[i].serviceGoodsBase.sid + '&goodsUserId='+obj.list[i].serviceGoodsBase.userId+'">预览</a>&nbsp;</td></tr>';
							}else{
								...
								'<td>' + obj.goodsList[i].serviceGoodsBase.userNickName + '</td>' +
								'<td><a href="' +view+ obj.goodsList[i].serviceGoodsBase.sid + '">查看</a>&nbsp;' +
									'<a href="'+testurl+'?sid=' + obj.list[i].serviceGoodsBase.sid + '&goodsUserId='+obj.list[i].serviceGoodsBase.userId+'">预览</a>&nbsp;<a href="'+edit + obj.goodsList[i].serviceGoodsBase.sid +'&company='+obj.goodsList[i].serviceGoodsBase.userId+ '">编辑</a></td></tr>';
							}
							$("#form_container").append(liststr);
